<article class="<?php echo (is_front_page())? 'swiper-slide padding-bottom-xs': 'col-12 col-md-6 col-xl-4' ?> gallery">
    <a class="gallery-content" href="<?php echo $link ?>">
        <div class="gallery-image-area">
            <img class="gallery-image" src="<?php echo $thumbnail ?>" alt="<?php echo get_the_post_thumbnail_caption() ?>">
        </div>

        <h2 class="main-font gallery-title"><?php echo $title ?></h2>

        <span class="gallery-description"><?php echo wp_trim_words($excerpt, 30, '...'); ?></span>

        <span class="underline main-font gallery-read">
            VER FOTOS
