            ...
            <div class="col-12 col-xl-4 d-flex flex-column  align-items-center">
                ...
                <ul class="d-flex flex-wrap gap-3 list-unstyled margin-top-xxs">
                    <?php if ($contact['email']): ?>
                        <li>
                            <a target="_blank" href="mailto:<?php echo $contact['email']?>" title="Enviar email para <?php echo $contact['email']?>">
                    ...
                    <?php if ($contact['whatsapp']): ?>
                        <li>
                            <a target="_blank" href="<?php echo sc_wtt_link($contact['whatsapp'])?>" title="Whatsapp">
                    ...
                    <?php if ($contact['facebook']): ?>
                        <li>
                            <a target="_blank" href="<?php echo $contact['facebook']?>" title="Facebook da paróquia">
                    ...
                    <?php if ($contact['instagram']): ?>
                        <li>
                            <a target="_blank" href="<?php echo $contact['instagram']?>" title="Instagram da paróquia">
